...
namespace Facturacion.Server.Migrations
{
    ...
    [Migration("20260923163809_20260923_M_LongitudFraccionArancelaria")]
    partial class _20260923_M_LongitudFraccionArancelaria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facturacion.Server.Data.Entidades.Documentos.DatosComercioExterior", b =>
                {
                    ...
                    b.ToTable("DatosComercioExterior", (string)null);
                });
            ...
            modelBuilder.Entity("Facturacion.Server.Data.Entidades.Plataforma.CompraTimbres", b =>
                {
                    ...
                    b.Property<string>("EmpresaNombreAlComprar")
                        .IsRequired()
                        .HasMaxLength(254)
                        .HasColumnType("nvarchar(254)");

                    b.Property<string>("EmpresaRfcAlComprar")
                        .IsRequired()
                        .HasMaxLength(13)
                        .HasColumnType("nvarchar(13)");
            ...
            modelBuilder.Entity("Facturacion.Server.Data.Entidades.Plataforma.ConfiguracionDelSistema", b =>
                {
                    b.Property<byte>("Id")
                        .HasColumnType("tinyint");

                    b.Property<Guid>("ActualizadaPorOperadorId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("ActualizadaUtc")
                        .HasColumnType("datetime2");

                    b.Property<string>("AsuntoContrasena")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<string>("AsuntoVerificacion")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");

                    b.Property<string>("ContrasenaSmtpCifrada")
                        .HasMaxLength(2048)
                        .HasColumnType("nvarchar(2048)");

                    b.Property<string>("CuerpoContrasena")
                        .IsRequired()
                        .HasMaxLength(8000)
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CuerpoVerificacion")
                        .IsRequired()
                        .HasMaxLength(8000)
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NombreDelSistema")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.ToTable("ConfiguracionDelSistema", null, t =>
                        {
                            t.HasCheckConstraint("CK_ConfiguracionDelSistema_Unica", "[Id] = 1");
                        });
                });
            ...
            modelBuilder.Entity("Facturacion.Server.Data.Entidades.Plataforma.PermisoOperador", b =>
                {
                    ...
                    b.HasKey("OperadorId", "Permiso");

                    b.HasIndex("Permiso")
                        .HasDatabaseName("IX_OperadoresPermisos_Permiso");

                    b.ToTable("OperadoresPermisos", (string)null);
                });
            ...
            modelBuilder.Entity("Facturacion.Server.Data.Entidades.Documentos.DatosComercioExterior", b =>
                {
                    b.HasOne("Facturacion.Server.Data.Entidades.Documentos.Comprobante", "Comprobante")
                        .WithOne()
                        .HasForeignKey("Facturacion.Server.Data.Entidades.Documentos.DatosComercioExterior", "ComprobanteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
