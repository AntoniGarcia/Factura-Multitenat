...
if (args is ["--cargar-catalogo-comercio", var catalogoComercio, var rutaCatalogoComercio])
{
    await CargaDeCatalogosComercioExteriorCli.EjecutarAsync(aplicacion, catalogoComercio, rutaCatalogoComercio);
    return;
}
