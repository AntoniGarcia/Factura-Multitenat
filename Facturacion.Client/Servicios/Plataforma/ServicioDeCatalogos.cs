...
/// la sesión, revalidando con ETag (ARQUITECTURA.md §7). Es el que alimenta selects instantáneos
...
/// comprobantes mal emitidos (ARQUITECTURA.md §4), así que se pierde al cerrar la pestaña como el
...
public sealed class ServicioDeCatalogos(IHttpClientFactory fabrica)
{
    ...
    /// <summary>Las claves vigentes de un catálogo precargado, o vacío si no está en la lista de ARQUITECTURA.md §7.</summary>
